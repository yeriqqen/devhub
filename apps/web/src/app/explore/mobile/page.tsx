...
// Define mobile project interface
...
// Replace with your actual mobile projects
const mobileProjects: MobileProject[] = [];

const platforms = ['All', 'iOS & Android', 'iOS', 'Android'];
...
export default function MobileProjectsPage() {
    ...
    const filteredProjects = selectedPlatform === 'All'
        ? mobileProjects
        : mobileProjects.filter(project => project.platform === selectedPlatform);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
                {platforms.map((platform) => (
                    <button
                        ...
                        className={`px-6 py-2 rounded-full transition-all duration-200 ${selectedPlatform === platform
            ...
            {filteredProjects.length > 0 ? (
                    ...
                    {filteredProjects.map((project) => (
                        ...
                        >
                            <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200 hover:border-gray-300">
                                {/* Project Image */}
                                <div className="aspect-[3/4] bg-gradient-to-br from-green-50 to-emerald-100 relative overflow-hidden">
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <div className="text-center">
                                            <div className="w-16 h-20 bg-green-600 rounded-xl mx-auto mb-4 flex items-center justify-center">
                ...
                <div className="text-center py-16">
                    ...
                    <h3 className="text-xl font-medium text-gray-900 mb-2">No Mobile Apps Yet</h3>
                    <p className="text-gray-600 mb-6">Add your mobile application projects to showcase your work.</p>
                    <Link
                        href="/explore"
